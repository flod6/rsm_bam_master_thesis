...
# Save the model
torch.save(best_model.state_dict(), output + "/Models/covar_best_FCNN_Regression_change.pt")
...
# Store the results 
results_covar.to_csv(output + "/Result_Models/covar_results_FCNN_Regression_change.csv")
...
predictions_covar.to_csv(output + "/Predictions_Models/covar_predictions_FCNN_Regression_change.csv")
