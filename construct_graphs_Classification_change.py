...
for i, j in adjacency_matrices.items():
    ...
    tmp_sys_risk["diff_delta_covar"] = (tmp_sys_risk["diff_delta_covar"] > 0).astype(int)
    ...
    skip_cols = ["gvkey", "date", "conm", "diff_delta_covar", "covar", "lag_covar"] 
...
save_path = os.path.join(input, "Clean/covar_graphs_Classification_change.pkl")
